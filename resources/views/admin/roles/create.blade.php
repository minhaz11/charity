...
<section class="content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-11">
                <form id="RolePermissionAddForm" action="{{ url('role/create') }}" method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-header bg-light">
                            <h3 class="card-title"><strong>Creat Role with Permissions</strong></h3>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9 form-error">
                                            <textarea type="text" name="description" id="description" class="form-control" placeholder="Desciption">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                                                ...
                                                <td class="text-center">
                                                    <div class="form-group clearfix">
                                                        <div class="icheck-success d-inline">
                                                            ...
                                                            <input type="checkbox" name="permissions[]" value="{{ $groupPermission->id }}" id="permission_{{$groupPermission->id}}" name="role">
                        ...
                        <div class="card-footer clearfix">
                            ...
                            <button type="submit" class="btn btn-info float-right" id="rolePermissionAddButton">
                                <i class="fas fa-circle-notch fa-spin loader" style="display: none;"></i>
                                <span id="rolePermissionAddButtonText">Create</span>
                            </button>
                        </div>
                    </div>
                </form>
    ...
    $(function() {
        $.validator.setDefaults({
            submitHandler: function(form) {
                $("#rolePermissionAddButton").attr("disabled", true).on('click', function(e) {
                    e.preventDefault();
                });
                $(".loader").show();
                $("#rolePermissionAddButtonText").text("Creating...");
                form.submit();
            }
        });
        $('#RolePermissionAddForm').validate({
            rules: {
                name: {
                    required: true,
                },
